 ...
 * 
 * bulletBase.js: Base file holding old D3 functions (from previous FIVA source code) to render bullet chart
 */
  ...
  function bullet(g) {
   ...
   // document.writeln(markers.call(this, d, i));
    ...
    var markerArray = [1, 0];
      ...
      // Update the red range rects.
      var range2 = g.selectAll("rect.range2")
          .data(rangez);

      range2.enter().append("svg:rect")
          .attr("class", function(d, i) { return "range2 e" + i; })
      ...
      var marker = g.selectAll("line.marker")
          .data(markerz);
      //MDEV change ("y1", height/6) ("y2", height * 5/6)
